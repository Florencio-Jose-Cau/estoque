      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/'.$foto.'" class="user-image" alt="User Image">
              <span class="hidden-xs">'.$usuario.'</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="dist/img/'.$foto.'" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="dist/img/'.$foto.'" class="img-circle" style="height:50px; width:50px;" alt="User Image">
...
<!-- Produtos -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="prod/"><i class="fa fa-circle-o"></i>Produtos</a></li>
            <li><a href="prod/addprod.php"><i class="fa fa-circle-o"></i>Add Produtos</a></li>
            <li><a href="itens/"><i class="fa fa-circle-o"></i>Itens</a></li>
             <li><a href="itens/totalitens.php"><i class="fa fa-circle-o"></i>Total Itens</a></li>
            <li><a href="itens/additens.php"><i class="fa fa-circle-o"></i>Add Itens</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="fabricante/addfabricante.php"><i class="fa fa-circle-o"></i>Add Fabricante</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="representante/"><i class="fa fa-circle-o"></i>Representantes</a></li>
            <li><a href="representante/addRepresentante.php"><i class="fa fa-circle-o"></i>Add Representante</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="usuarios/"><i class="fa fa-circle-o"></i>Lista</a></li>
            <li><a href="usuarios/addusuarios.php"><i class="fa fa-circle-o"></i>Add Usuários</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="cliente/"><i class="fa fa-circle-o"></i>Lista</a></li>
            <li><a href="cliente/addcliente.php"><i class="fa fa-circle-o"></i>Add Cliente</a></li>
