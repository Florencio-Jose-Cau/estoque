...
<link rel="stylesheet" href="../views/dist/img/cau.">
<?php

$url = 'http://localhost/ges/views/';
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="'.$url.'dist/img/'.$foto.'" class="user-image" alt="User Image">
              <span class="hidden-xs">'.$usuario.'</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="'.$url.'dist/img/'.$foto.'" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="'.$url.'dist/img/'.$foto.'" class="img-circle" style="height:50px; width:50px;" alt="User Image">
